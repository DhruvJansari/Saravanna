                ...
                {NAV_LINKS.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`${playfair.className} font-medium px-4 py-2 text-sm lg:text-base rounded-full transition-all duration-300 whitespace-nowrap ${isActive
                    ...
                    return (
                      ...
                      >
                        <Link
                          href={link.href}
                          onClick={(e) => handleNavigation(e, link.href)}
                          className={`${playfair.className} font-medium block px-4 py-3 rounded-xl text-base transition ${isActive
                              ? "bg-black text-white"
